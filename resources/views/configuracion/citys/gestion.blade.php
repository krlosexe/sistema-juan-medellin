@extends('layouts.app')
			        ...
			        <div class="container-fluid">
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Ciudades</h6>
			          ...
			          @include('configuracion.citys.store')
					  @include('configuracion.citys.view')
					  @include('configuracion.citys.edit')
	...
	@section('CustomJs')
		...
		<script>
			...
			function update(){
				enviarFormularioPut("#form-update", 'api/city', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/city', '#cuadro2');
			}
