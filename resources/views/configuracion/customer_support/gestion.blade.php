		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Atencion al Cliente</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Atencion al Cliente</h6>
			          ...
			          @include('configuracion.customer_support.store')
					  @include('configuracion.customer_support.view')
					  @include('configuracion.customer_support.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_customer-support, #modulo_Configuracion").addClass("active");

				verifyPersmisos(id_user, tokens, "customer-support");
			});



			function update(){
				enviarFormularioPut("#form-update", 'api/customer-support', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/customer-support', '#cuadro2');
			}
			...
			*/
			function edit(tbody, table){
				$(tbody).on("click", "span.editar", function(){
					...
					$("#id_edit").val(data.id_customer_support)
					cuadros('#cuadro1', '#cuadro4');
				});
			}
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-customer-support/'+data.id_customer_support+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-customer-support/'+data.id_customer_support+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-customer-support/'+data.id_customer_support+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
