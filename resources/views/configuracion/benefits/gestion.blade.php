			        ...
			        <div class="container-fluid">
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Beneficios</h6>
			          ...
			          @include('configuracion.benefits.store')
					  @include('configuracion.benefits.view')
					  @include('configuracion.benefits.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_benefits, #modulo_Configuracion").addClass("active");

				verifyPersmisos(id_user, tokens, "benefits");
			});



			function update(){
				enviarFormularioPut("#form-update", 'api/benefits', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/benefits', '#cuadro2');
			}
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-benefits/'+data.id_benefits+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-benefits/'+data.id_benefits+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-benefits/'+data.id_benefits+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
