			        ...
			        <div class="container-fluid">
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Paises</h6>
			          ...
			          @include('configuracion.countries.store')
					  @include('configuracion.countries.view')
					  @include('configuracion.countries.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_countries, #modulo_Configuracion").addClass("active");

				verifyPersmisos(id_user, tokens, "countries");
			});



			function update(){
				enviarFormularioPut("#form-update", 'api/countries', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/countries', '#cuadro2');
			}
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-countries/'+data.id_countries+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-countries/'+data.id_countries+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-countries/'+data.id_countries+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
