			        ...
			        <div class="container-fluid">
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Formas de Pago</h6>
			          ...
			          @include('configuracion.way-to-pay.store')
					  @include('configuracion.way-to-pay.view')
					  @include('configuracion.way-to-pay.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_way-to-pay, #modulo_Configuracion").addClass("active");

				verifyPersmisos(id_user, tokens, "way-to-pay");
			});



			function update(){
				enviarFormularioPut("#form-update", 'api/way-to-pay', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/way-to-pay', '#cuadro2');
			}
			...
			*/
			function edit(tbody, table){
				$(tbody).on("click", "span.editar", function(){
					...
					$("#id_edit").val(data.id_way_to_pay)
					cuadros('#cuadro1', '#cuadro4');
				});
			}
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-way-to-pay/'+data.id_way_to_pay+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-way-to-pay/'+data.id_way_to_pay+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-way-to-pay/'+data.id_way_to_pay+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
