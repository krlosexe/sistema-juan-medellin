		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Lineas de Negocio</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Lineas de Negocio</h6>
			          ...
			          @include('configuracion.lineas-negocio.store')
					  @include('configuracion.lineas-negocio.view')
					  @include('configuracion.lineas-negocio.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_business-lines, #modulo_Configuracion").addClass("active");
			...
			function update(){
				enviarFormularioPut("#form-update", 'api/line-business', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/line-business', '#cuadro2');
			}
			...
			*/
			function ver(tbody, table){
				$(tbody).on("click", "span.consultar", function(){
					...
					$("#nombre-view").val(data.nombre_line).attr("disabled", "disabled")
			...
			*/
			function edit(tbody, table){
				$(tbody).on("click", "span.editar", function(){
					...
					$("#nombre-edit").val(data.nombre_line)
					cuadros('#cuadro1', '#cuadro4');
					$("#id_edit").val(data.id_line)
					cuadros('#cuadro1', '#cuadro4');
				});
			}
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-line/'+data.id_line+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-line/'+data.id_line+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/status-line/'+data.id_line+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
